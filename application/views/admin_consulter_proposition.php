    ...
    <div class="panel panel-proposition">
      ...
      <div class="panel-footer">
        ...
        <div class="pull-right">
          ...
          <a href = "<?php echo base_url('admin/autorise/proposition/'.$id.'/oui'); ?>" class="btn btn-success">Oui</a>
          <a href = "<?php echo base_url('admin/autorise/proposition/'.$id.'/non'); ?>" class="btn btn-danger">Non </a>
