    ...
    <div class="panel panel-proposition">
      ...
      <div class="panel-footer">
        ...
        <div class="pull-right">
          ...
          <a href = "<?php echo base_url('admin/commentaires/autorise/'.$id.'?autorise=oui'); ?>" class="btn btn-success">Oui</a>
          <a href = "<?php echo base_url('admin/commentaires/autorise/'.$id.'?autorise=non'); ?>" class="btn btn-danger">Non </a>
