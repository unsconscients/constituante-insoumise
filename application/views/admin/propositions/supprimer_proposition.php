    ...
    <div class="panel panel-proposition">
      ...
      <div class="panel-footer">
        ...
        <div class="pull-right">
          ...
          <a href = "<?php echo base_url('admin/propositions/supprime/'.$id.'?autorise=oui'); ?>" class="btn btn-success">Oui</a>
          <a href = "<?php echo base_url('admin?page=propositions'); ?>" class="btn btn-danger">Non </a>
